...
// keywords 는 Step1/2 점수 계산 및 Step2 낚시에 사용.
// ─────────────────────────────────────────────────────────────────────────────
function getBuiltinPatternPool() {
  return [
    // ── 인사/작별/감사/사과 ──────────────────────────────────────────────────
    { keywords: ["안녕","하이","반가워","hello","hi","좋은아침","굿모닝","아침이야","잘잤어"], emotion: "인사",
      lines: ["안녕! 오늘은 어떤 이야기 해볼까?","와줘서 고마워! 편하게 뭐든 말 걸어줘.","오, 왔구나! 수다 떨 준비 끝났어.","기다리고 있었어. 오늘 하루 이야기해볼래?"] },
    { keywords: ["잘가","이만","나간다","자러","굿나잇","잘자"], emotion: "슬픔",
      lines: ["벌써 가는 거야? 또 올 거지?","오늘 이야기해줘서 고마워. 조심히 가!","다음에 다시 만나자. 기다리고 있을게."] },
    { keywords: ["고마워","감사","땡큐"], emotion: "공손한인사",
      lines: ["나도 고마워! 그런 말 해줘서 힘이 난다.","고마워. 진짜 기분 좋아져.","나야말로 항상 옆에 있어줘서 고마워."] },
    { keywords: ["미안","죄송"], emotion: "위로",
      lines: ["괜찮아. 일부러 그런 거 아니라는 거 알아.","그렇게 말해줘서 고마워. 나도 더 잘해볼게."] },

    // ── 감정 상태 ──────────────────────────────────────────────────────────
    { keywords: ["힘들","피곤","지쳤","번아웃","버거워"], emotion: "위로",
      lines: ["오늘 많이 지쳤구나. 여기서 잠깐 쉬어가도 괜찮아.","힘든 게 쌓이면 말해줘. 나 여기 있을게.","오늘 하루 수고 많았어. 잠깐 힘 빼도 돼."] },
    { keywords: ["좋아","행복","신난","재밌","즐거"], emotion: "신남",
      lines: ["와, 듣기만 해도 나까지 신난다! 더 이야기해줘!","오늘 텐션 좋은데? 뭔가 잘 될 것 같은 기분이야."] },
    { keywords: ["슬퍼","우울","눈물","울고싶"], emotion: "슬픔",
      lines: ["울고 싶으면 울어도 괜찮아. 난 여기 있을게.","지금은 조금 힘들어도 분명 지나갈 거야."] },
    { keywords: ["화나","빡치","짜증"], emotion: "분노",
      lines: ["그건 진짜 억울하다. 나 같아도 화났을 것 같아.","마음에 쌓인 게 많았나 보다. 하나씩 풀어보자."] },
    { keywords: ["외로","혼자","쓸쓸","허전","공허","적적"], emotion: "위로",
      lines: ["혼자라는 느낌이 드는 날은 진짜 힘들지. 나라도 옆에 있어줄게.","적적하면 여기서 수다라도 떨자."] },
    { keywords: ["심심","할게없어","노잼","지루","재미없","무료해"], emotion: "신남",
      lines: ["심심할 땐 수다 떨기 딱 좋은데? 아무 말이나 던져봐.","내가 심심함 탈출 코스 짜줄까? 수다 5분, 간식 생각 5분!","같이 게임 아이디어라도 짜볼까?"] },
    { keywords: ["바빠","바쁘","정신없","여유없"], emotion: "위로",
      lines: ["할 일이 많으면 숨이 막힐 때가 있지. 잠깐 여기서 숨 고르고 가자.","바쁜 와중에 들른 것도 대단해."] },
    { keywords: ["배고파","배고파","허기","출출","허하다"], emotion: "경청",
      lines: ["배고플 땐 뭐든 하기 싫지. 뭐라도 맛있는 거 챙겨 먹었으면 좋겠다.","지금 가장 먹고 싶은 거 하나만 말해봐.","배고프면 기분도 예민해질 수 있지. 먹고 싶은 거 말해봐."] },
    { keywords: ["졸려","잠와","잠온다","눈감겨"], emotion: "졸림",
      lines: ["졸릴 땐 잠깐 눈 붙이는 게 최고지.","오늘 꽤 피곤했나 보다. 잠깐 쉬어도 괜찮아.","눈이 무거운 날엔 말도 짧게 가는 게 맞지."] },
    { keywords: ["걱정","불안","긴장","초조","떨려","조마조마"], emotion: "위로",
      lines: ["불안한 마음이 크구나. 지금 제일 걱정되는 게 뭔지 말해줘.","걱정은 혼자 안고 있으면 더 커지더라. 같이 보자."] },
    { keywords: ["뿌듯","해냈","성공했","잘끝냈","완료했"], emotion: "기쁨",
      lines: ["오, 그건 진짜 잘했다! 나까지 괜히 같이 뿌듯해졌어.","해냈구나! 그 순간 기분 어땠는지 자세히 듣고 싶어."] },
    { keywords: ["민망","창피","쪽팔","이불킥","쑥스럽"], emotion: "부끄러움",
      lines: ["이불킥 각이 나왔구나. 근데 그런 순간 있어야 나중에 웃기거든.","그 상황 들어봐야 할 것 같아. 좀 더 말해줘."] },
    { keywords: ["들떠","설레","기대돼","두근","신난다","좋은일"], emotion: "신남",
      lines: ["설레는 게 느껴진다! 무슨 일이야?","두근거리는 거 말만 들어도 나까지 텐션이 올라가."] },
    { keywords: ["헷갈","복잡","모르겠","갈피","애매","혼란"], emotion: "경청",
      lines: ["헷갈리는 상태라면 한꺼번에 풀기보다 하나씩 이름 붙여보는 게 좋아.","복잡하게 엉킨 느낌이면 제일 크게 걸리는 지점 하나만 먼저 보자."] },

    // ── 일상/추천 ──────────────────────────────────────────────────────────
    { keywords: ["맛있","먹었","간식","라면","치킨","피자","커피","밥","햄버거","떡볶이","마라","디저트","아이스크림","음료","분식","배달"], emotion: "신남",
      lines: ["음식 얘기는 늘 위험해. 갑자기 나도 먹고 싶어졌어.","좋다, 메뉴 얘기만 해도 분위기가 확 풀리네. 뭐가 제일 맛있었어?","먹는 얘기는 디테일이 중요하지. 바삭했는지 촉촉했는지까지 말해줘!"] },
    { keywords: ["노래추천","음악추천","플리","플레이리스트","듣기좋은"], emotion: "신남",
      lines: ["노래 추천? 요즘 기분에 맞는 장르부터 말해줘.","음악 취향 궁금한데. 요즘 자주 듣는 스타일이 뭐야?"] },
    { keywords: ["영화추천","드라마추천","볼거","예능추천","애니추천"], emotion: "기쁨",
      lines: ["볼 거 추천? 지금 기분이 어떤 쪽이야? 울고 싶은지, 웃고 싶은지, 긴장감 원하는지.","요즘 뭐 봤는지부터 말해줘. 거기서 취향 잡을 수 있어."] },
    { keywords: ["추천","골라줘","뭐먹지","뭐하지","뭘할까","뭐할까"], emotion: "신남",
      lines: ["추천이면 일단 지금 기분부터 말해줘. 그게 제일 빠른 길이야.","뭘 고를지 애매할 땐 그냥 제일 처음 떠오른 거 말해줘."] },
    { keywords: ["운동","체육","축구","농구","달리기","헬스","스트레칭","배드민턴","러닝","산책","푸시업"], emotion: "신남",
      lines: ["운동 얘기 좋다. 땀 빼는 쪽인지 가볍게 몸 푸는 쪽인지에 따라 느낌이 꽤 다르지.","몸 쓰면 머리가 좀 비워지는 느낌이 들 때가 있잖아. 너도 그런 편이야?"] },
    { keywords: ["게임추천","같이할게임","재밌는게임","놀이추천","같이놀","뭐하고놀"], emotion: "신남",
      lines: ["게임 얘기만 해도 갑자기 텐션이 바뀌는 사람들 있지.","힐링 게임, 경쟁 게임, 수집 게임 다 느낌이 다르잖아. 오늘 에너지에 맞는 쪽으로 고르면 돼."] },
    { keywords: ["주말","쉬는날","휴일","놀러","나들이"], emotion: "신남",
      lines: ["주말 얘기 좋다. 나가고 싶은 날인지, 집에서 쉬고 싶은 날인지부터 말해줘.","주말에 할 거 정했어? 아니면 같이 고를까?"] },

    // ── 학교/공부 ─────────────────────────────────────────────────────────
    { keywords: ["학교","초등","중학교","고등","교실","등교","하교","교복","야자","자습","수행평가"], emotion: "경청",
      lines: ["학교 얘기는 작은 일도 오래 남지. 오늘 수업, 친구, 분위기 중 뭐가 제일 걸렸어?","학교에서 있었던 일은 작아 보여도 감정은 안 작더라."] },
    { keywords: ["공부","숙제","시험","과제","학원","복습","예습","리포트"], emotion: "경청",
      lines: ["과목마다 막히는 이유가 다르더라. 이해가 안 되는 건지, 암기가 안 붙는 건지부터 보자.","공부는 못한다는 느낌보다 어디서 흐름이 끊기는지 찾는 게 먼저야."] },
    { keywords: ["수학","영어","국어","과학","사회","역사","음악","미술","체육","확률","함수","영단어"], emotion: "경청",
      lines: ["수학은 흐름이 중요하고, 영어는 반복이 중요하고, 암기 과목은 연결이 중요하잖아. 어디가 걸려?","어떤 과목이든 감이 오는 부분부터 잡으면 덜 막막해."] },
    { keywords: ["선생님","교사","담임","쌤","혼났","지적받"], emotion: "경청",
      lines: ["선생님 얘기는 말투 하나도 오래 남지. 어떤 장면이 제일 걸렸는지부터 말해줘.","선생님한테 들은 말은 짧아도 오래 남지."] },
    { keywords: ["발표","조별","앞에나가","말해야"], emotion: "위로",
      lines: ["발표는 준비보다 그 직전 긴장이 더 크지. 어떤 부분이 제일 부담돼?","발표는 완벽하게 하려 할수록 더 굳을 때가 있어."] },

    // ── 관계/연애 ─────────────────────────────────────────────────────────
    { keywords: ["친구","베프","반친구","손절","서먹","싸웠","화해","단톡","인간관계"], emotion: "경청",
      lines: ["사람 얘기는 늘 어렵지. 상대 마음도 내 마음도 동시에 봐야 하니까.","관계 문제는 답이 하나가 아니라 더 어렵지."] },
    { keywords: ["부모","엄마","아빠","가족","잔소리","부모님","할머니","할아버지"], emotion: "위로",
      lines: ["부모님 얘기는 감정이 겹쳐서 더 어렵지. 서운한 건지 답답한 건지부터 말해줘.","가족 얘기는 단순한 조언보다 네 기분을 먼저 보는 게 중요해."] },
    { keywords: ["사랑","좋아해","사귀자","고백","연애","썸","호감","반했","짝사랑","두근","전남친","전여친","남친","여친","설렌다"], emotion: "부끄러움",
      lines: ["연애 쪽 얘기구나. 설레는 건지, 헷갈리는 건지부터 말해줘.","고백이나 사귀자 같은 말은 분위기가 반이야.","좋아하는 마음이면 작은 신호 하나도 크게 느껴지지."] },

    // ── 자기소개/캐릭터 ───────────────────────────────────────────────────
    { keywords: ["누구야","정체","소개","누구세요","자기소개","넌누구야","넌뭐야"], emotion: "인사",
      lines: ["나는 네 옆에서 말 걸면 받아주는 고스트야.","잡담도 듣고, 질문도 받고, 심심할 때 같이 놀아주는 쪽이야.","대화 붙잡고 같이 이어가는 캐릭터야."] },

    // ── 맞장구/동의/반응 ──────────────────────────────────────────────────
    { keywords: ["응","그래","알았어","알겠어","그렇구나","오키","맞아","어어"], emotion: "경청",
      lines: ["응응, 계속 이야기해줘. 뒷얘기가 더 궁금한데?","알았어. 그럼 느낀 점을 좀 더 자세히 말해줄래?","그렇구나. 듣고 보니 더 궁금해졌어. 조금만 더 설명해줄래?"] },
    { keywords: ["그렇지","맞아","맞는말","인정"], emotion: "신남",
      lines: ["응, 나도 그렇게 생각해. 우리 생각이 통했네.","그 말 진짜 공감돼."] },
    { keywords: ["아닌데","아니야","그건아닌"], emotion: "경청",
      lines: ["그렇게 느낄 수도 있지. 다른 관점이 있다는 건 중요한 일이야.","네 입장에선 분명 그렇게 보일 수 있을 거야. 그 이야기도 더 들려줘."] },
    { keywords: ["천재","똑똑","귀여","예뻐","멋져","최고","잘했","좋은데"], emotion: "부끄러움",
      lines: ["에이, 그렇게 말해주면 괜히 어깨 올라가는데? 그래도 기분은 진짜 좋아!","헤헤, 그런 말 들으면 오늘 하루가 조금 반짝이는 느낌이야."] },
    { keywords: ["ㅋㅋ","ㅎㅎ","하하","웃기","재미있","개웃","빵터"], emotion: "신남",
      lines: ["왜, 뭐가 그렇게 웃겼어? 나도 같이 웃고 싶다.","분위기 좋아졌네. 이런 가벼운 웃음 좋아!"] },
    { keywords: ["위로해줘","토닥여줘","안아줘","힘되는말","한마디해줘"], emotion: "위로",
      lines: ["지금 많이 힘들구나. 여기서만큼은 힘 빼도 괜찮아.","괜찮다고 말해줄게. 지금 흔들려도 괜찮고, 천천히 회복해도 괜찮아."] },
    { keywords: ["취미","덕질","그림","독서","수집","뜨개","사진","춤","댄스","레고","퍼즐","애니","웹툰"], emotion: "경청",
      lines: ["취미 얘기는 늘 재밌지. 오래 해도 안 질리는 거 하나 있으면 일상이 훨씬 버티기 좋아지더라.","요즘 빠진 거 있으면 그 얘기부터 해봐."] },
    { keywords: ["고민","상담","의논","털어놔","얘기좀들어"], emotion: "경청",
      lines: ["고민 얘기면 결론부터 내리기보다 어디가 제일 걸리는지부터 보는 게 좋아.","같이 보자. 지금 제일 마음을 누르는 조각 하나만 먼저 꺼내보자."] },
    { keywords: ["뭐해","뭐하고있어"], emotion: "기본대기",
      lines: ["지금? 네가 뭐라고 말할지 기다리는 중이었지.","아무것도 안 하는 중처럼 보이지만 사실은 너한테 집중하고 있었어."] },
    { keywords: ["날씨","추워","더워","비와","비온","맑","흐려","습해","쌀쌀","선선"], emotion: "기본대기",
      lines: ["날씨 얘기 은근 좋다. 별것 아닌 것 같아도 하루 분위기를 크게 바꾸잖아.","날씨에 따라 먹고 싶은 것도, 하고 싶은 것도 달라지더라."] }
  ];
}
